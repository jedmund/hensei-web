	...
	<ModalBody>
		<div class="sections">
			<section>
				...
				<SettingsRow
					title={m.explore_settings_min_characters()}
					subtitle={m.explore_settings_min_characters_desc()}
				>
					{#snippet control()}
						<div class="slider-row">
							...
							<span class="slider-value"
								>{m.counter_characters({ count: String(minCharacters) })}</span
							>
						</div>
					{/snippet}
				</SettingsRow>
				<SettingsRow
					title={m.explore_settings_min_weapons()}
					subtitle={m.explore_settings_min_weapons_desc()}
				>
					{#snippet control()}
						<div class="slider-row">
							<Slider
				...
				<SettingsRow
					title={m.explore_settings_min_summons()}
					subtitle={m.explore_settings_min_summons_desc()}
				>
					{#snippet control()}
						<div class="slider-row">
							<Slider
			...
			<section>
				...
				<SettingsRow
					title={m.explore_settings_name_quality()}
				...
				<SettingsRow
					title={m.explore_settings_user_quality()}
				...
				<SettingsRow
					title={m.explore_settings_original()}
