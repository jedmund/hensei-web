<script lang="ts">
	...
	const showCollectionPrompt = $derived(collectionFilterActive && isAuthenticated && !hasCollection)
...
<section class="explore">
	...
	{#if showCollectionPrompt}
		<div class="empty-collection">
			...
			<Button href={localizeHref(`/${data.account?.username}/collection`)} size="small"
				>{m.explore_go_to_collection()}</Button
			>
		</div>
	...
	{:else if partiesQuery.isError}
		<div class="error">
			...
			<p>
				{m.explore_load_error({ error: partiesQuery.error?.message || m.explore_unknown_error() })}
			</p>
